...
from IM2DeepMulti.utils import BASEMODELCONFIG, MeanMAESorted, LowestMAESorted, FlexibleLossSorted, evaluate_predictions, plot_predictions
...
def main():
    ...
    ccs_df_train = pickle.load(open('/home/robbe/IM2DeepMulti/data/decoyeval/ccs_df_train_Unimodals.pkl', 'rb'))
    AtomEnc = pickle.load(open("/home/robbe/IM2DeepMulti/data/decoyeval/X_train_AtomEnc-Unimodals.pickle", "rb"))
    Globals = pickle.load(open("/home/robbe/IM2DeepMulti/data/decoyeval/X_train_GlobalFeatures-Unimodals.pickle", "rb"))
    DiAminoAtomEnc = pickle.load(open('/home/robbe/IM2DeepMulti/data/decoyeval/X_train_DiAminoAtomEnc-Unimodals.pickle', 'rb'))
    OneHot = pickle.load(open('/home/robbe/IM2DeepMulti/data/decoyeval/X_train_OneHot-Unimodals.pickle', 'rb'))
    y_train = pickle.load(open('/home/robbe/IM2DeepMulti/data/decoyeval/y_train-Unimodals.pickle', 'rb'))

    ccs_df_valid = pickle.load(open('/home/robbe/IM2DeepMulti/data/decoyeval/ccs_df_valid_Unimodals.pkl', 'rb'))
    AtomEnc_valid = pickle.load(open("/home/robbe/IM2DeepMulti/data/decoyeval/X_valid_AtomEnc-Unimodals.pickle", "rb"))
    Globals_valid = pickle.load(open("/home/robbe/IM2DeepMulti/data/decoyeval/X_valid_GlobalFeatures-Unimodals.pickle", "rb"))
    DiAminoAtomEnc_valid = pickle.load(open('/home/robbe/IM2DeepMulti/data/decoyeval/X_valid_DiAminoAtomEnc-Unimodals.pickle', 'rb'))
    OneHot_valid = pickle.load(open('/home/robbe/IM2DeepMulti/data/decoyeval/X_valid_OneHot-Unimodals.pickle', 'rb'))
    y_valid = pickle.load(open('/home/robbe/IM2DeepMulti/data/decoyeval/y_valid-Unimodals.pickle', 'rb'))
    ...
    # y_test is an array of a single list of two values, convert it to a tensor of shape (n, 2)
    y_test = torch.tensor(np.vstack(y_test))
    ...
    plot_predictions(predictions, targets, mean_mae, mean_pearson_r, config, path='/home/robbe/IM2DeepMulti/figs/decoyeval/')
