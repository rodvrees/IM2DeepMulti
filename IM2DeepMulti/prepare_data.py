...
def prepare_data(config):
    ...
    Train_AtomEnc = pickle.load(open("/home/robbe/IM2DeepMulti/data/X_train_AtomEnc-multi.pickle", "rb"))
    Train_Globals = pickle.load(
        open("/home/robbe/IM2DeepMulti/data/X_train_GlobalFeatures-multi.pickle", "rb")
    )
    Train_DiAminoAtomEnc = pickle.load(open('/home/robbe/IM2DeepMulti/data/X_train_DiAminoAtomEnc-multi.pickle', 'rb'))
    Train_OneHot = pickle.load(open('/home/robbe/IM2DeepMulti/data/X_train_OneHot-multi.pickle', 'rb'))
    y_train = pickle.load(open('/home/robbe/IM2DeepMulti/data/y_train-multi.pickle', 'rb'))
    ...
    Valid_AtomEnc = pickle.load(open("/home/robbe/IM2DeepMulti/data/X_valid_AtomEnc-multi.pickle", "rb"))
    Valid_Globals = pickle.load(open("/home/robbe/IM2DeepMulti/data/X_valid_GlobalFeatures-multi.pickle", "rb"))
    Valid_DiAminoAtomEnc = pickle.load(open('/home/robbe/IM2DeepMulti/data/X_valid_DiAminoAtomEnc-multi.pickle', 'rb'))
    Valid_OneHot = pickle.load(open('/home/robbe/IM2DeepMulti/data/X_valid_OneHot-multi.pickle', 'rb'))
    y_valid = pickle.load(open('/home/robbe/IM2DeepMulti/data/y_valid-multi.pickle', 'rb'))

    y_valid = np.vstack(y_valid)

    # Test
    ccs_df_test = pickle.load(open('/home/robbe/IM2DeepMulti/data/ccs_df_test.pkl', 'rb'))
    Test_AtomEnc = pickle.load(open("/home/robbe/IM2DeepMulti/data/X_test_AtomEnc-multi.pickle", "rb"))
    Test_Globals = pickle.load(
        open("/home/robbe/IM2DeepMulti/data/X_test_GlobalFeatures-multi.pickle", "rb")
    )
    Test_DiAminoAtomEnc = pickle.load(open('/home/robbe/IM2DeepMulti/data/X_test_DiAminoAtomEnc-multi.pickle', 'rb'))
    Test_OneHot = pickle.load(open('/home/robbe/IM2DeepMulti/data/X_test_OneHot-multi.pickle', 'rb'))
    y_test = pickle.load(open('/home/robbe/IM2DeepMulti/data/y_test-multi.pickle', 'rb'))
